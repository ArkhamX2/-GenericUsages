...
namespace GenericUsages.Library.GenericSort
{
    public class Student
    {
        ...
        #endregion
        public int CompareStudent(Student a, Student b)
        {
            return String.Compare(a.Name, b.Name);
        }
        public override string ToString()
        {
            return String.Format("\tИмя: {0}\tУниверситет: {1}\tФакультет: {2}\tВремя обучения: {3}\tСумма долгов: {4}",
                this.Name, this.University, this.Faculty, this.StudingYears, this.SumDebt);
        }
    }
}